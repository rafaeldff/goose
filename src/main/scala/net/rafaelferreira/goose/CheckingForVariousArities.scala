...
trait CheckingForVariousArities extends CheckHelpers {self: GooseStructure with Specification =>
  ...
  def check[T1: ClassManifest, T2: ClassManifest, T3: ClassManifest, T4: ClassManifest, R](resultExpression: (T1, T2, T3, T4) => R)(testDefinition: (Dependency[T1], Dependency[T2], Dependency[T3], Dependency[T4]) => When[R] => When[R]): Fragments = {
  ...
  def check[T1: ClassManifest, T2: ClassManifest, T3: ClassManifest, T4: ClassManifest, T5: ClassManifest, R](resultExpression: (T1, T2, T3, T4, T5) => R)(testDefinition: (Dependency[T1], Dependency[T2], Dependency[T3], Dependency[T4], Dependency[T5]) => When[R] => When[R]): Fragments = {
  ...
  def check[T1: ClassManifest, T2: ClassManifest, T3: ClassManifest, T4: ClassManifest, T5: ClassManifest, T6: ClassManifest, R](resultExpression: (T1, T2, T3, T4, T5, T6) => R)(testDefinition: (Dependency[T1], Dependency[T2], Dependency[T3], Dependency[T4], Dependency[T5], Dependency[T6]) => When[R] => When[R]): Fragments = {
  ...
  def check[T1: ClassManifest, T2: ClassManifest, T3: ClassManifest, T4: ClassManifest, T5: ClassManifest, T6: ClassManifest, T7: ClassManifest, R](resultExpression: (T1, T2, T3, T4, T5, T6, T7) => R)(testDefinition: (Dependency[T1], Dependency[T2], Dependency[T3], Dependency[T4], Dependency[T5], Dependency[T6], Dependency[T7]) => When[R] => When[R]): Fragments = {
  ...
  def check[T1: ClassManifest, T2: ClassManifest, T3: ClassManifest, T4: ClassManifest, T5: ClassManifest, T6: ClassManifest, T7: ClassManifest, T8: ClassManifest, T9: ClassManifest, R](resultExpression: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => R)(testDefinition: (Dependency[T1], Dependency[T2], Dependency[T3], Dependency[T4], Dependency[T5], Dependency[T6], Dependency[T7], Dependency[T8], Dependency[T9]) => When[R] => When[R]): Fragments = {
